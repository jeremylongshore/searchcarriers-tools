...
description: "Analyzes carrier evidence for safety evidence interpreter. Use when a user asks, \"Explain the safety record for DOT 1234567 and show\u2026\". Trigger with \"Explain the safety record for DOT\u2026\"."
...
Safety Evidence Interpreter helps an operator explain a carrier safety record without inventing a universal safety score. It solves this operational failure: Teams confuse FMCSA safety ratings, BASIC information, crashes, and missing data, leading to false passes and false rejections.
...
The bounded result is: Return CLEAR EVIDENCE, CONCERN, or REVIEW REQUIRED under the caller policy; do not create an official score.
...
**Routes/tools:** GET /api/v3/company/{dot}?fields=safety,basic_scores,risk_factors; GET /api/v3/company/{dot}/crashes

Read the returned rating and date, inspection exposure, OOS measures, BASIC evidence, crashes, and API risk factors. Keep counts and denominators together.
...
Capture: Rating with date, safety measures with observation windows, crash facts, inspection exposure, missing fields, and source/as-of.
...
**Next action:** Escalate concerns to the caller policy or SearchCarriers qualification; verify official status when the decision is consequential.
...
**Should trigger:** “Explain the safety record for DOT 1234567 and show what is unknown.”

Produce the bounded record, show the decisive evidence and unknowns, and give one
operational next action.

**Should not trigger:** “Check whether the carrier has cargo insurance.”
...
| Missing field or empty data | Not rated is not satisfactory or unsafe. Zero inspections is low exposure, not proof of safety. |
