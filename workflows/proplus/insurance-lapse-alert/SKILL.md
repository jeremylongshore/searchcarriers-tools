...
description: "Analyzes carrier evidence for insurance change review. Use when a user asks, \"Review this cancellation event for DOT 1234567 and\u2026\". Trigger with \"Review this cancellation event for\u2026\"."
...
Insurance Change Review helps an operator evaluate a supplied insurance change or current filing and create a bounded response. It solves this operational failure: A cancellation notice may be future-dated, replaced, stale, or unrelated to the required coverage, while false alarms disrupt loads.
...
The bounded result is: Return NO CURRENT GAP, UPCOMING REVIEW, CURRENT GAP, or UNRESOLVED.
...
Validate event provenance, refetch current filings, identify the applicable requirement, check replacement/overlap, and classify operational impact.
...
Capture: Event source/time, current filing, replacement evidence, requirement source, affected loads, classification, owner, and deadline.
...
**Next action:** Hold affected tendering when required coverage cannot be confirmed and verify with the insurer through an independent contact.
...
**Should trigger:** “Review this cancellation event for DOT 1234567 and check replacement coverage.”

Produce the bounded record, show the decisive evidence and unknowns, and give one
operational next action.

**Should not trigger:** “Create a general contact list.”
...
| Missing field or empty data | An unavailable refetch or unknown requirement is UNRESOLVED, not clear. |
