...
description: "Analyzes carrier evidence for carrier decision report builder. Use when a user asks, \"Build an audit-ready vetting report from these tool\u2026\". Trigger with \"Build an audit-ready vetting\u2026\"."
allowed-tools: Read, mcp__searchcarriers-ops-reporter__generate_report, mcp__searchcarriers-ops-reporter__generate_fleet, mcp__searchcarriers-ops-reporter__generate_compare, mcp__searchcarriers-ops-reporter__export_data
...
Carrier Decision Report Builder helps an operator turn carrier evidence into an auditable report or export without changing the underlying verdict. It solves this operational failure: Pretty reports can conceal missing evidence, stale data, and the difference between API facts and analyst judgment.
...
The bounded result is: Return READY or INCOMPLETE; formatting may not upgrade REVIEW to PASS.
...
**Routes/tools:** MCP tools: generate_report, generate_fleet, generate_compare, export_data

Choose one report purpose, preserve upstream data and verdicts, label source/as-of and missing sections, and protect spreadsheet outputs from formulas.
...
Capture: Subject identity, purpose, evidence sections, policy/model disclosure, missing evidence, human decision, source/as-of, and export manifest.
...
**Next action:** Have the decision owner sign off, then retain the report according to internal policy.


Registered tool identifiers: `mcp__searchcarriers-ops-reporter__generate_report`, `mcp__searchcarriers-ops-reporter__generate_fleet`, `mcp__searchcarriers-ops-reporter__generate_compare`, `mcp__searchcarriers-ops-reporter__export_data`.
...
**Should trigger:** “Build an audit-ready vetting report from these tool outputs.”

Produce the bounded record, show the decisive evidence and unknowns, and give one
operational next action.

**Should not trigger:** “Monitor a carrier watch list.”
...
| Missing field or empty data | If an upstream section failed, mark the report incomplete and include the exact recovery action. |
